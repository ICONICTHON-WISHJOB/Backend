...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ['port-0-backend-m3ffo7y635cd1bb2.sel4.cloudtype.app','https://port-0-backend-m3ffo7y635cd1bb2.sel4.cloudtype.app', 'https://wish-job.netlify.app', 'localhost', '127.0.0.1']
...
CSRF_TRUSTED_ORIGINS =['https://port-0-backend-m3ffo7y635cd1bb2.sel4.cloudtype.app', 'https://wish-job.netlify.app', 'https://localhost', 'https://127.0.0.1']
